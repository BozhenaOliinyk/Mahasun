        ...
        (async () => {
            try {
                ...
                if (query) {
                    ...
                    url = `/outlets/search/?${params.toString()}`;
                }
                ...
                <div className="page-header-row">
                    <div >
                        <input className="search"
                               ...
                               placeholder="Пошук торгової точки"
                               aria-label="Пошук торгової точки"
                        />
                    </div>
                    ...
                    return (
                        ...
                        >
                            <figure className="card-image-wrapper">
                                <img src="/static/images/outlet_placeholder.jpg"
                                     alt={`Торгова точка ${values[1] || ""}`}/>
                            </figure>
